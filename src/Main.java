...
public class Main {
    ...
    public static Player setupPlayer() {
        ...
        return new Player(playerName, 100, playerWeapon);
    }
    ...
    static void displayEndingDetails(Player player) {
        ...
        System.out.println("| " + player.getPlayerName() + " remaining health: " + ((player.getHealth() > 0) ? player.getHealth() : "0"));
        System.out.println("|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
        ...
        System.out.println("| " + computerPlayer.getPlayerName() + " remaining health: " + (computerPlayer.getHealth() > 0 ? computerPlayer.getHealth() : "0"));
        System.out.println("|~~~~~~~~~~~~~~~~~~~~~~~~~~~ Thanks for playing ~~~~~~~~~~~~~~~~~~~~~~~~~~~");
    }
